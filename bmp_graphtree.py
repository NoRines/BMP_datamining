from bmp_decisiontree import *
from graphviz import Digraph


def treetograph(node, outname, attribnames = None, dot = None, nodeid = 0):
	if attribnames == None:
	...
	dot.node(str(nodeid), label=nodename)
